...
def getPreference(men_file,women_file):
    """reads json data from men_file, women_file into mPref, wPref respectively
    
    Args:
        men_file ([type]): json file containing preference by each man
        women_file ([type]): json file containing preferences by each woman
    
    Returns:
        dict,dict: men Preferences , women preferences
    """
...
############### Below is not being used, just some experimentation stuff ###########
